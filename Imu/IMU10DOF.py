...
class MPU9250():
    def __init__(self):
        ...
        self.accel_sens = 4 * 9.80665 / 32768;
    ...
    def showAll(self):
        print('Accelerations=', self.readAccel(), '+/-', self.accel_accuracy, self.accel_unit)
        print('Angular Velocities=', self.readGyro(), '+/-', self.gyro_accuracy, self.gyro_unit)
        print('Magnetic Field=', self.readMagnet(), '+/-', self.magnet_accuracy, self.magnet_unit)
